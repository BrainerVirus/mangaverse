			...
			<ScrollView className="flex-1 px-5 pt-6" contentInsetAdjustmentBehavior="automatic" contentContainerStyle={{ paddingBottom: tabBarPadding }}>
				...
				<View className="rounded-[28px] border border-border/30 bg-card/70 p-5">
					<View className="flex-row items-center justify-between">
						<View className="flex-1 pr-4">
							<Text className="text-preset-2 font-heading font-semibold text-foreground">Private mode</Text>
				...
				{privateMode ? (
					<View className="mt-4 rounded-[28px] border border-warning/40 bg-warning/10 p-5">
						<Text className="text-preset-2 font-heading font-semibold text-warning">Private mode is on</Text>
				...
				{entries.length === 0 ? (
					<View className="mt-6 rounded-[28px] border border-border/30 bg-card/80 p-6">
						<Text className="text-preset-2 font-heading font-semibold text-foreground">Nothing here yet.</Text>
						...
						<View className="rounded-[28px] border border-border/30 bg-card/70 p-5">
							<View className="flex-row items-center justify-between">
								<View>
									...
									<Text className="text-preset-2 font-heading font-semibold text-foreground mt-2">{entries.length} reads</Text>
								</View>
							...
							<View className="mt-4 gap-3">
								{entries.map((entry) => (
									<View key={entry.id} className="rounded-[26px] border border-border/30 bg-card/70 p-5">
										<Text className="text-preset-2 font-heading font-semibold text-foreground">{entry.title}</Text>
