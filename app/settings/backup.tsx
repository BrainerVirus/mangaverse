		...
		<View className="bg-background flex-1">
			...
			<ScrollView className="flex-1 px-5 pt-6" contentInsetAdjustmentBehavior="automatic">
				...
				<View className="border-border/30 bg-card/70 rounded-box border p-5">
					...
					<Text
						className="bg-primary text-preset-1 font-heading text-primary-foreground rounded-badge mt-3 px-4 py-2 text-center font-semibold tracking-[0.2em] uppercase"
